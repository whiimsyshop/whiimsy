...
const ContactPage = () => {
  return (
    <section className="about-main laptop:w-full">
      ...
      <div className="mt-10 mb-10 flex flex-col gap-8 laptop:flex laptop:flex-row laptop:justify-center laptop:items-center tablet:px-0 laptop:px-20 px-6 md:px-6 ml-10">
        <div className="laptop:w-1/2 px-2">
          <ContactForm />
        </div>
        <div className="laptop:w-1/2 px-4 flex flex-col items-center justify-center">
          <h3 className="font-bold text-xl mb-8 text-left w-full pl-32">
            Don&apos;t like filling out forms? <br />
            Here are other ways to connect with us:
          </h3>
          <div className="mb-8 text-left w-full pl-32">
