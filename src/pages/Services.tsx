        ...
        <div>
            ...
            <section id="section-1" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <Link href="/workshop" className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Coming Soon</Link>
                </div>
            ...
            <section id="section-2" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row-reverse">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <p className='text-justify text-xl mt-4'>
                        A discount will be applied to your next purchase for each jar and lid that you bring that is in good condition. For example, if you bring us a jar and lid then you will get $2.50 off your next purchase. Yes, it can be the same day you bring them in.
                    </p>
                    <p className='text-justify text-xl mt-6'>
                        Schedule a drop off time! See you soon..
                    </p>
                    <Link href="/https://wa.me/+918981256860?text=Hey!%20Whiimsy%20Team.%20I%20would%20like%20to%20know%20more%20about%20Recycle%20Program." className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Get in Touch</Link>
                </div>
            ...
            <section id="section-3" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <Link href="/corporate" className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Coming Soon</Link>
                </div>
            ...
            <section id="section-4" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row-reverse">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <Link href="https://wa.me/+918981256860?text=Hey!%20Whiimsy%20Team.%20I%20would%20like%20to%20know%20more%20about%20Collaboration." className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Get in Touch</Link>
                </div>
            ...
            <section id="section-6" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row-reverse">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <Link href="https://forms.gle/HpyNvwVGreEcgtRS6" className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Get in Touch</Link>
                </div>
            ...
            <section id="section-7" className="mx-2 my-2 flex flex-col-reverse gap-12 rounded-xl bg-gray-200 p-5 md:mx-16 md:p-10 lg:mx-32 lg:flex-row">
                <div className='w-full lg:w-1/2 flex flex-col'>
                    ...
                    <Link href="https://wa.me/+918981256860?text=Hey!%20Whiimsy%20Team.%20I%20would%20like%20to%20know%20more%20about%20Donation." className="self-start mt-6 rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Get in Touch</Link>
                </div>
            ...
            <div className="flex flex-col items-center justify-between gap-5 rounded-t-xl border border-col5 bg-col5 px-5 py-5 md:px-16 lg:flex-row lg:gap-0 lg:px-32">
                ...
                <Link href="/contact" className="h-fit w-fit rounded-full bg-white px-8 py-3 font-semibold text-col5 shadow-lg hover:shadow-xl transition-all duration-200 hover:bg-gray-200">Contact Us</Link>
            </div>
        </div>
    );
};
