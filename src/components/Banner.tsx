    ...
    <div className="banner">
      <div className="banner-track">
        <p className="banner-text">
          🎁 Monthly Giveaway | <span className="highlight">FREE CANDLE</span> | Monthly Giveaway |{" "}
          <span className="highlight">FREE CANDLE</span> | Monthly Giveaway |{" "}
          <span className="highlight">FREE CANDLE</span> | Monthly Giveaway |{" "}
          <span className="highlight">FREE CANDLE</span> 🎁
        </p>
        <p className="banner-text">
          🎁 Monthly Giveaway | <span className="highlight">FREE CANDLE</span> | Monthly Giveaway |{" "}
          <span className="highlight">FREE CANDLE</span> | Monthly Giveaway |{" "}
